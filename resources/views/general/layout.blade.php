<!DOCTYPE html>
    <html lang="pt-br">
        <head>
            ...
            <meta name="keywords" content="nosz, reaproveitamento, alimentos, reaproveitamento de alimentos,
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container">
                        <a class="navbar-brand d-flex align-items-center" href="{{ '/' }}">
                            <img src="{{ asset('imgs/favicons/logo.png') }}"
                            class="navbar-brand-image img-fluid" alt="Logo da Nósz"> Nósz </a>
                        ...
                        <div class="col-lg-4 col-12 me-auto">
                            ...
                            <ul class="social-icone mt-4">
                                <li class="social-icone-item">
                                    <a target="_blank" class="social-icone-link bi-facebook" title="Facebook"
                                    rel="noopener" href="https://www.facebook.com/profile.php?id=61556614689733">
                                    </a>
                                </li>

                                <li class="social-icone-item">
                                    <a target="_blank" class="social-icone-link bi-twitter"
                                    title="X/Twitter" rel="noopener" href="https://twitter.com/NoszTCC">
                                    </a>
                                </li>

                                <li class="social-icone-item">
                                    <a target="_blank" class="social-icone-link bi-instagram"
                                    title="Instagram" rel="noopener" href="https://www.instagram.com/noszdevs/">
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-5 col-12">
                            ...
                            <div class="d-flex">
                                <a target="_blank" href="https://www.cps.sp.gov.br/" rel="noopener">
                                    <img src="{{ asset('imgs/parcerias/CPS.png')}}"
                                    class="avaliacoes-block-image img-fluid" alt="ETEC - CPS">
