...
<section class="download-section section-padding">
    <div class="container">
                            ...
                            <div class="download-form-body">
                                <div class="row">
                                    <div class="col-12 text-center">
                                        ...
                                        <select class="col-12 form-select form-control" aria-label="Default
                                        select example" name="tipo" id="tipo" required>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        maxlength="255" name="email" id="email" required>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-12">
                                        ...
                                        maxlength="15" name="telefone" id="telefone" required>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-12 mb-3">
                                        ...
                                        <input type="file" style="display:none" placeholder="Logo"
                                        name="logo" id="logo" disabled>
                                    </div>

                                    <div class="col-lg-12 col-12">
                                        <em> Quais são as suas expectativas para o App? </em>
                                        <textarea rows="3" class="form-control" placeholder="Comentário (Opcional)"
                                        name="mensagem" id="mensagem"></textarea>
                                    </div>
                                    ...
                                    class="col-lg-3 col-0 mx-auto mb-5 mt-5 mt-lg-5 ps-lg-3">
                                        <em> Aponte a câmera neste QR Code para acessar nosso aplicativo </em>
                                        <img src="{{ asset('imgs/favicons/qrcode.png')}}"
                                        width="100%" alt="QR Code">
                                    </div>

                                    <div class="col-lg-12 col-12 mt-5">
                                        <div class="col-lg-12 col-12 mx-auto mt-5 mb-5 mt-lg-0 ps-lg-3">
                                            <iframe class="google-map" width="100%" height="300" title="Mapa Etec"
                                            referrerpolicy="no-referrer-when-downgrade" allowfullscreen
                                            src="https://encurtador.com.br/yBJ78">
                                            </iframe>
                                        </div>
                                    </div>
                                </div>
        ...
        integrity="sha384-7iQjT0yJL9VdWWPbC9GS8pF04rcTzCLmZyM3nDfF5AZEftsbOrhDzAbwD47rMxR8"
        ...
        <script>
            ...
            email.addEventListener('change', e => {
                fetch("{{ route('emailExistente') }}?email=" + email.value, { method: 'GET' })
                    .then(async response => await response)
                    .then(response => { if (response.status === 400) { alert('Email já está em uso!'); } });
            });
            ...
            cpfOuCnpj.addEventListener('keyup', e => {
                ...
                if (tipo.value === "users") {
                    ...
                    switch (valorAtual.length) {
                        ...
                        break;
                        case 14:
                        valorFormatado = valorAtual.replace(/^(\d{2})(\d{3})(\d{3})(\d{4})(\d{2})$/, '$1.$2.$3/$4-$5');
                        break;
                    }
                }

                valorFormatado = valorFormatado ?? e.target.value;
                if (valorFormatado) { e.target.value = valorFormatado; }
            });
            ...
            telefone.addEventListener('keyup', e => {
                ...
                const valorAtual = e.target.value.replace(/\D/g, ''); let valorFormatado = '';
