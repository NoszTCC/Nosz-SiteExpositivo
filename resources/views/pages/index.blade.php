            ...
            <div class="avaliacoes">
                    ...
                    <div class="avaliacoes-content">
                        <div class="avaliacoes-block">
                            <div class="avaliacoes-block-image-wrap d-flex align-items-center">
                                <img src="imgs/avaliacoes/sandra.png"
                                class="avaliacoes-block-image img-fluid" alt="Sandra">
                ...
                <div class="avaliacoes-container avaliacoes-container-right">
                    <div class="avaliacoes-content">
                        <div class="avaliacoes-block">
                            <div class="avaliacoes-block-image-wrap d-flex align-items-center">
                                <img src="imgs/avaliacoes/pedro.png"
                                class="avaliacoes-block-image img-fluid" alt="Pedro">
                ...
                <div class="avaliacoes-container avaliacoes-container-left">
                    <div class="avaliacoes-content">
                        <div class="avaliacoes-block">
                            <div class="avaliacoes-block-image-wrap d-flex align-items-center">
                                <img src="imgs/avaliacoes/olivia.png"
                                class="avaliacoes-block-image img-fluid" alt="Olívia">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                ...
                class="personalizado-form contatos-form">
                @method("post")
                @csrf

                @if(session('retorno')) <em class="text-white"> {{ session('retorno') }} </em> @endif
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="mensagem" id="messagem" rows="4" class="form-control" placeholder="Mensagem"
                        required></textarea>
                    </div>
                </div>
